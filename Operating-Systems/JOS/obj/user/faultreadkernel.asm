	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026c:	0f be 80 f1 12 80 00 	movsbl 0x8012f1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800468:	c7 44 24 08 09 13 80 	movl   $0x801309,0x8(%esp)
  80046f:	00 
  ...
  800488:	c7 44 24 08 12 13 80 	movl   $0x801312,0x8(%esp)
  80048f:	00 
  ...
  8004ba:	b8 02 13 80 00       	mov    $0x801302,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fb6:	e8 4b f1 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  800fbb:	c7 04 24 94 15 80 00 	movl   $0x801594,(%esp)
