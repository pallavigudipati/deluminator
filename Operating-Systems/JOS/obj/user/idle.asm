...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 a0 	movl   $0x8012a0,0x802000
  800041:	12 80 00 
...
libmain(int argc, char **argv)
{
  ...
  800065:	00 00 00 
	int envid;
	envid = sys_getenvid();
  800068:	e8 0b 01 00 00       	call   800178 <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  80014e:	00 
  80014f:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800156:	00 
  800157:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80015e:	00 
  80015f:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  800166:	e8 d5 02 00 00       	call   800440 <_panic>
...
sys_yield(void)
{
  ...
  8001bc:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f7:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  80020d:	00 
  80020e:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800215:	00 
  800216:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021d:	00 
  80021e:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  800225:	e8 16 02 00 00       	call   800440 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800254:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  80026b:	00 
  80026c:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800273:	00 
  800274:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027b:	00 
  80027c:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  800283:	e8 b8 01 00 00       	call   800440 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c9:	00 
  8002ca:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  8002d1:	00 
  8002d2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002d9:	00 
  8002da:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  8002e1:	e8 5a 01 00 00       	call   800440 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800327:	00 
  800328:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  80032f:	00 
  800330:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800337:	00 
  800338:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  80033f:	e8 fc 00 00 00       	call   800440 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800378:	7e 28                	jle    8003a2 <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80037a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80037e:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800385:	00 
  800386:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  80038d:	00 
  80038e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800395:	00 
  800396:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
  80039d:	e8 9e 00 00 00       	call   800440 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003d1:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003d6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8003d9:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8003dc:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800416:	00 
  800417:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  80041e:	00 
  80041f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800426:	00 
  800427:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800445:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800448:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80044b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800451:	e8 22 fd ff ff       	call   800178 <sys_getenvid>
  ...
  800464:	89 74 24 08          	mov    %esi,0x8(%esp)
  800468:	89 44 24 04          	mov    %eax,0x4(%esp)
  80046c:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
  ...
  800482:	e8 53 00 00 00       	call   8004da <vcprintf>
	cprintf("\n");
  800487:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8004c5:	e8 f2 fb ff ff       	call   8000bc <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800516:	e8 b7 01 00 00       	call   8006d2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80052e:	e8 89 fb ff ff       	call   8000bc <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80063c:	0f be 80 02 13 80 00 	movsbl 0x801302(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800838:	c7 44 24 08 1a 13 80 	movl   $0x80131a,0x8(%esp)
  80083f:	00 
  ...
  800858:	c7 44 24 08 23 13 80 	movl   $0x801323,0x8(%esp)
  80085f:	00 
  ...
  80088a:	b8 13 13 80 00       	mov    $0x801313,%eax
