...
libmain(int argc, char **argv)
{
  ...
  800063:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800066:	c7 05 08 20 80 00 00 	movl   $0x0,0x802008
  80006d:	00 00 00 
	int envid;
	envid = sys_getenvid();
  800070:	e8 0b 01 00 00       	call   800180 <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  800156:	00 
  800157:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  80015e:	00 
  80015f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800166:	00 
  800167:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800215:	00 
  800216:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  80021d:	00 
  80021e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800225:	00 
  800226:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800273:	00 
  800274:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  80027b:	00 
  80027c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800283:	00 
  800284:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d1:	00 
  8002d2:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  8002d9:	00 
  8002da:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e1:	00 
  8002e2:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80032f:	00 
  800330:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  800337:	00 
  800338:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80033f:	00 
  800340:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80038d:	00 
  80038e:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  800395:	00 
  800396:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80039d:	00 
  80039e:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80041e:	00 
  80041f:	c7 44 24 08 b8 12 80 	movl   $0x8012b8,0x8(%esp)
  800426:	00 
  800427:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042e:	00 
  80042f:	c7 04 24 d5 12 80 00 	movl   $0x8012d5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800453:	8b 35 04 20 80 00    	mov    0x802004,%esi
  800459:	e8 22 fd ff ff       	call   800180 <sys_getenvid>
  ...
  80046c:	89 74 24 08          	mov    %esi,0x8(%esp)
  800470:	89 44 24 04          	mov    %eax,0x4(%esp)
  800474:	c7 04 24 e4 12 80 00 	movl   $0x8012e4,(%esp)
  ...
  80048a:	e8 53 00 00 00       	call   8004e2 <vcprintf>
	cprintf("\n");
  80048f:	c7 04 24 ac 12 80 00 	movl   $0x8012ac,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8004cd:	e8 f2 fb ff ff       	call   8000c4 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80051e:	e8 af 01 00 00       	call   8006d2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800536:	e8 89 fb ff ff       	call   8000c4 <sys_cputs>
