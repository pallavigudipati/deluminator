...
libmain(int argc, char **argv)
{
  ...
  80006d:	00 00 00 
	int envid;
	envid = sys_getenvid();
  800070:	e8 37 0c 00 00       	call   800cac <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026c:	0f be 80 e8 12 80 00 	movsbl 0x8012e8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800397:	ff 24 85 a0 13 80 00 	jmp    *0x8013a0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800488:	c7 44 24 08 09 13 80 	movl   $0x801309,0x8(%esp)
  80048f:	00 
  ...
  8004ba:	b8 f9 12 80 00       	mov    $0x8012f9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c82:	00 
  800c83:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800c8a:	00 
  800c8b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c92:	00 
  800c93:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d41:	00 
  800d42:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800d49:	00 
  800d4a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d51:	00 
  800d52:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d9f:	00 
  800da0:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800da7:	00 
  800da8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800daf:	00 
  800db0:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800dfd:	00 
  800dfe:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800e05:	00 
  800e06:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0d:	00 
  800e0e:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e5b:	00 
  800e5c:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800e63:	00 
  800e64:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6b:	00 
  800e6c:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800eb9:	00 
  800eba:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800ec1:	00 
  800ec2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec9:	00 
  800eca:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f4a:	00 
  800f4b:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800f52:	00 
  800f53:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f5a:	00 
  800f5b:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fa0:	c7 04 24 50 15 80 00 	movl   $0x801550,(%esp)
  ...
  800fb6:	e8 4b f1 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  800fbb:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
