...
umain(int argc, char **argv)
{
  ...
  800041:	e8 2d 01 00 00       	call   800173 <cprintf>
  ...
  800059:	e8 15 01 00 00       	call   800173 <cprintf>
}
  80005e:	c9                   	leave  
  80005f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006f:	8b 75 0c             	mov    0xc(%ebp),%esi
	...
	thisenv = 0;
  800072:	c7 05 04 20 80 00 00 	movl   $0x0,0x802004
  800079:	00 00 00 
	int envid;
	envid = sys_getenvid();
  80007c:	e8 2b 0c 00 00       	call   800cac <sys_getenvid>
...
exit(void)
{
  ...
  8000c9:	e8 81 0b 00 00       	call   800c4f <sys_env_destroy>
}
  8000ce:	c9                   	leave  
  8000cf:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000fd:	e8 ee 0a 00 00       	call   800bf0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80014e:	e8 af 01 00 00       	call   800302 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800166:	e8 85 0a 00 00       	call   800bf0 <sys_cputs>
