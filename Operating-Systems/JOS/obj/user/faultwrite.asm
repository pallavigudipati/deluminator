...
libmain(int argc, char **argv)
{
  ...
  800089:	e8 a6 ff ff ff       	call   800034 <umain>
	...
	// exit gracefully
	exit();
  80008e:	e8 0d 00 00 00       	call   8000a0 <exit>
}
  800093:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800096:	8b 75 fc             	mov    -0x4(%ebp),%esi
  800099:	89 ec                	mov    %ebp,%esp
  80009b:	5d                   	pop    %ebp
  80009c:	c3                   	ret    
