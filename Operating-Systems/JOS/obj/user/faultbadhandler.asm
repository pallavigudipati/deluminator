...
sys_env_destroy(envid_t envid)
{
  ...
  80017a:	00 
  80017b:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  800182:	00 
  800183:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80018a:	00 
  80018b:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800223:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  800239:	00 
  80023a:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  800241:	00 
  800242:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800249:	00 
  80024a:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800280:	8b 7d 14             	mov    0x14(%ebp),%edi
  800283:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  800297:	00 
  800298:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  80029f:	00 
  8002a0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a7:	00 
  8002a8:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002f5:	00 
  8002f6:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  8002fd:	00 
  8002fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800305:	00 
  800306:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800353:	00 
  800354:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  80035b:	00 
  80035c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800363:	00 
  800364:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003b1:	00 
  8003b2:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  8003b9:	00 
  8003ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c1:	00 
  8003c2:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003fd:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800442:	00 
  800443:	c7 44 24 08 ea 12 80 	movl   $0x8012ea,0x8(%esp)
  80044a:	00 
  80044b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800452:	00 
  800453:	c7 04 24 07 13 80 00 	movl   $0x801307,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800471:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800474:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800477:	8b 35 00 20 80 00    	mov    0x802000,%esi
  ...
  800490:	89 74 24 08          	mov    %esi,0x8(%esp)
  800494:	89 44 24 04          	mov    %eax,0x4(%esp)
  800498:	c7 04 24 18 13 80 00 	movl   $0x801318,(%esp)
  ...
  8004ae:	e8 53 00 00 00       	call   800506 <vcprintf>
	cprintf("\n");
  8004b3:	c7 04 24 3c 13 80 00 	movl   $0x80133c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800542:	e8 bb 01 00 00       	call   800702 <vprintfmt>
	sys_cputs(b.buf, b.idx);
...
cprintf(const char *fmt, ...)
{
  ...
  80057f:	c9                   	leave  
  800580:	c3                   	ret    
  800581:	66 90                	xchg   %ax,%ax
  800583:	66 90                	xchg   %ax,%ax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80066c:	0f be 80 3e 13 80 00 	movsbl 0x80133e(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800868:	c7 44 24 08 56 13 80 	movl   $0x801356,0x8(%esp)
  80086f:	00 
  ...
  800888:	c7 44 24 08 5f 13 80 	movl   $0x80135f,0x8(%esp)
  80088f:	00 
  ...
  8008ba:	b8 4f 13 80 00       	mov    $0x80134f,%eax
