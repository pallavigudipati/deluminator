...
libmain(int argc, char **argv)
{
  ...
  8000b9:	00 00 00 
	int envid;
	envid = sys_getenvid();
  8000bc:	e8 2b 0c 00 00       	call   800cec <sys_getenvid>
  ...
  8000ce:	a3 04 20 80 00       	mov    %eax,0x802004
	...
	if (argc > 0)
  8000d3:	85 db                	test   %ebx,%ebx
  8000d5:	7e 07                	jle    8000de <libmain+0x3e>
		binaryname = argv[0];
  8000d7:	8b 06                	mov    (%esi),%eax
  8000d9:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  8000de:	89 74 24 04          	mov    %esi,0x4(%esp)
...
exit(void)
{
  ...
  800109:	e8 81 0b 00 00       	call   800c8f <sys_env_destroy>
}
  80010e:	c9                   	leave  
  80010f:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  80013d:	e8 ee 0a 00 00       	call   800c30 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80018e:	e8 af 01 00 00       	call   800342 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001a6:	e8 85 0a 00 00       	call   800c30 <sys_cputs>
