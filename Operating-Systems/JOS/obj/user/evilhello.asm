...
libmain(int argc, char **argv)
{
  ...
  800089:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  80008e:	89 74 24 04          	mov    %esi,0x4(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800152:	00 
  800153:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  80015a:	00 
  80015b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800162:	00 
  800163:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800211:	00 
  800212:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800219:	00 
  80021a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800221:	00 
  800222:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80026f:	00 
  800270:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800277:	00 
  800278:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80027f:	00 
  800280:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002cd:	00 
  8002ce:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  8002d5:	00 
  8002d6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002dd:	00 
  8002de:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80032b:	00 
  80032c:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800333:	00 
  800334:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80033b:	00 
  80033c:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800389:	00 
  80038a:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800391:	00 
  800392:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800399:	00 
  80039a:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80041a:	00 
  80041b:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800422:	00 
  800423:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042a:	00 
  80042b:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80044f:	8b 35 00 20 80 00    	mov    0x802000,%esi
  ...
  800468:	89 74 24 08          	mov    %esi,0x8(%esp)
  80046c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800470:	c7 04 24 d8 12 80 00 	movl   $0x8012d8,(%esp)
  ...
  800486:	e8 53 00 00 00       	call   8004de <vcprintf>
	cprintf("\n");
  80048b:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80051a:	e8 b3 01 00 00       	call   8006d2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80063c:	0f be 80 fe 12 80 00 	movsbl 0x8012fe(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800838:	c7 44 24 08 16 13 80 	movl   $0x801316,0x8(%esp)
  80083f:	00 
  ...
  800858:	c7 44 24 08 1f 13 80 	movl   $0x80131f,0x8(%esp)
  80085f:	00 
  ...
  80088a:	b8 0f 13 80 00       	mov    $0x80130f,%eax
