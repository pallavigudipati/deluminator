...
libmain(int argc, char **argv)
{
  ...
  800055:	00 00 00 
	int envid;
	envid = sys_getenvid();
  800058:	e8 0b 01 00 00       	call   800168 <sys_getenvid>
  ...
  800071:	7e 07                	jle    80007a <libmain+0x3e>
		binaryname = argv[0];
  ...
  80008b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80008e:	8b 75 fc             	mov    -0x4(%ebp),%esi
  800091:	89 ec                	mov    %ebp,%esp
  800093:	5d                   	pop    %ebp
  800094:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80013e:	00 
  80013f:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800146:	00 
  800147:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014e:	00 
  80014f:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  800156:	e8 d5 02 00 00       	call   800430 <_panic>
...
sys_yield(void)
{
  ...
  8001ac:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001fd:	00 
  8001fe:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800205:	00 
  800206:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020d:	00 
  80020e:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  800215:	e8 16 02 00 00       	call   800430 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80025b:	00 
  80025c:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  800263:	00 
  800264:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026b:	00 
  80026c:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  800273:	e8 b8 01 00 00       	call   800430 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b9:	00 
  8002ba:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  8002c1:	00 
  8002c2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c9:	00 
  8002ca:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  8002d1:	e8 5a 01 00 00       	call   800430 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800317:	00 
  800318:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  80031f:	00 
  800320:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800327:	00 
  800328:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  80032f:	e8 fc 00 00 00       	call   800430 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800368:	7e 28                	jle    800392 <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80036a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80036e:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800375:	00 
  800376:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  80037d:	00 
  80037e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800385:	00 
  800386:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  80038d:	e8 9e 00 00 00       	call   800430 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8003e7:	b8 0c 00 00 00       	mov    $0xc,%eax
  8003ec:	8b 55 08             	mov    0x8(%ebp),%edx
  8003ef:	89 cb                	mov    %ecx,%ebx
  8003f1:	89 cf                	mov    %ecx,%edi
  8003f3:	89 ce                	mov    %ecx,%esi
  ...
  8003f9:	7e 28                	jle    800423 <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003fb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003ff:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800406:	00 
  800407:	c7 44 24 08 aa 12 80 	movl   $0x8012aa,0x8(%esp)
  80040e:	00 
  80040f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800416:	00 
  800417:	c7 04 24 c7 12 80 00 	movl   $0x8012c7,(%esp)
  80041e:	e8 0d 00 00 00       	call   800430 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800423:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800426:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800435:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800438:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80043b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800441:	e8 22 fd ff ff       	call   800168 <sys_getenvid>
  ...
  800454:	89 74 24 08          	mov    %esi,0x8(%esp)
  800458:	89 44 24 04          	mov    %eax,0x4(%esp)
  80045c:	c7 04 24 d8 12 80 00 	movl   $0x8012d8,(%esp)
  800463:	e8 c3 00 00 00       	call   80052b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800468:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80046c:	8b 45 10             	mov    0x10(%ebp),%eax
  80046f:	89 04 24             	mov    %eax,(%esp)
  800472:	e8 53 00 00 00       	call   8004ca <vcprintf>
	cprintf("\n");
  800477:	c7 04 24 fc 12 80 00 	movl   $0x8012fc,(%esp)
  80047e:	e8 a8 00 00 00       	call   80052b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800483:	cc                   	int3   
  800484:	eb fd                	jmp    800483 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  80048b:	53                   	push   %ebx
  80048c:	83 ec 14             	sub    $0x14,%esp
  80048f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800492:	8b 03                	mov    (%ebx),%eax
  800494:	8b 55 08             	mov    0x8(%ebp),%edx
  800497:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  80049b:	83 c0 01             	add    $0x1,%eax
  80049e:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8004a0:	3d ff 00 00 00       	cmp    $0xff,%eax
  8004a5:	75 19                	jne    8004c0 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8004a7:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8004ae:	00 
  8004af:	8d 43 08             	lea    0x8(%ebx),%eax
  8004b2:	89 04 24             	mov    %eax,(%esp)
  8004b5:	e8 f2 fb ff ff       	call   8000ac <sys_cputs>
		b->idx = 0;
  8004ba:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8004c0:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004ff:	c7 04 24 88 04 80 00 	movl   $0x800488,(%esp)
  800506:	e8 b7 01 00 00       	call   8006c2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80050b:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800511:	89 44 24 04          	mov    %eax,0x4(%esp)
  800515:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  80051b:	89 04 24             	mov    %eax,(%esp)
  80051e:	e8 89 fb ff ff       	call   8000ac <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  80053e:	e8 87 ff ff ff       	call   8004ca <vcprintf>
	va_end(ap);
